...
<section class="sec" id="briefs">
  <div class="container">
    <div class="section-head">
      <div>
        <div class="kicker">&#xA7;03 · MORNING BRIEFS &amp; ROUTINES</div>
        <h2 class="section-title prose">Wake up to what matters.</h2>
      </div>
      <p class="section-lede prose ink-dim">
        Automated daily routines delivered straight to Telegram. Six brief types, full 5-field cron
        scheduling, CRUD via the dashboard UI and REST API, and HTML-formatted results with clickable
        links. Each routine runs as a Go-native fetcher &mdash; no Python, no external dependencies.
        Toggle, edit, or trigger any routine from the operator console.
      </p>
    </div>
    <div class="sec-grid">
      <div class="sec-card"><div class="sec-card-head"><div class="sec-card-icon"><svg width="18" height="18" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 2h12v12H2zM2 6h12M6 2v12"/></svg></div><span class="eyebrow">ROUTINE · HN</span></div><div class="sec-card-title prose">Hacker News</div><div class="sec-card-desc prose ink-dim">Top stories with points, comments, and discussion links. Configurable story count.</div></div>
      <div class="sec-card"><div class="sec-card-head"><div class="sec-card-icon"><svg width="18" height="18" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="7"/><path d="M1 8h14M8 1a10 10 0 0 1 3 7 10 10 0 0 1-3 7 10 10 0 0 1-3-7 10 10 0 0 1 3-7"/></svg></div><span class="eyebrow">ROUTINE · NEWS</span></div><div class="sec-card-title prose">World News</div><div class="sec-card-desc prose ink-dim">Headlines from major sources with attribution and date. AI-summarized for quick scanning.</div></div>
      <div class="sec-card"><div class="sec-card-head"><div class="sec-card-icon"><svg width="18" height="18" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2a5 5 0 0 0-5 5c0 2 1 3 2 4l1 3h4l1-3c1-1 2-2 2-4a5 5 0 0 0-5-5zM6 14h4"/></svg></div><span class="eyebrow">ROUTINE · WEATHER</span></div><div class="sec-card-title prose">Weather</div><div class="sec-card-desc prose ink-dim">Local forecast with temperature, humidity, wind, UV index. Today and tomorrow outlook with sunrise/sunset.</div></div>
      <div class="sec-card"><div class="sec-card-head"><div class="sec-card-icon"><svg width="18" height="18" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 14l3-3 2 2 4-4 3 3M2 2v12h12"/></svg></div><span class="eyebrow">ROUTINE · STOCKS</span></div><div class="sec-card-title prose">Stocks &amp; Crypto</div><div class="sec-card-desc prose ink-dim">Watchlist with last close, pre-market, and after-hours prices. Percentage change with trend indicators.</div></div>
      <div class="sec-card"><div class="sec-card-head"><div class="sec-card-icon"><svg width="18" height="18" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 8c0 2.2-1.8 4-4 4s-4-1.8-4-4V4a4 4 0 1 1 8 0v4z"/><path d="M8 12v2M6 14h4"/></svg></div><span class="eyebrow">ROUTINE · REDDIT</span></div><div class="sec-card-title prose">Reddit Trending</div><div class="sec-card-desc prose ink-dim">Top posts from your subscribed subreddits. Upvotes, comment count, and direct links. Coming soon.</div></div>
      <div class="sec-card"><div class="sec-card-head"><div class="sec-card-icon"><svg width="18" height="18" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M6 3H2v4h4V3zM14 3h-4v4h4V3zM14 9h-4v4h4V9zM6 9H2v4h4V9z"/></svg></div><span class="eyebrow">ROUTINE · GITHUB</span></div><div class="sec-card-title prose">GitHub Trending</div><div class="sec-card-desc prose ink-dim">Trending repos by language and timeframe. Stars, forks, and descriptions. Coming soon.</div></div>
    </div>
  </div>
</section>
